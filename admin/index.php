        ...
        <div class="login-content">
            ...
            <div class="login-form">
                <form name="form1" action="" method="post">
                    ...
                    <button type="submit" name="submit1" class="btn btn-success btn-flat m-b-30 m-t-30">Iniciar sesión</button>


                    <div class="alert alert-danger" id="errormsg" style="margin-top: 10px; display: none">
                        <strong>Invalido!</strong> Nombre de usuario o Contraseña
                    </div>
