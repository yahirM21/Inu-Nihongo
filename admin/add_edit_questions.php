        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1>Añade una pregunta <?php echo "<font color='red'>" . $exam_category . "</font>"; ?></h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                <form name="form1" action="" method="post" enctype="multipart/form-data">
                                    <div class="card">
                                        <div class="card-header"><strong>Añade una pregunta con texto</strong>
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="form-group"><label for="company"
                                                               ...
                                                               placeholder="Agrega la primera opcion"
                                                               class="form-control" required>
                                            </div>
                                            ...
                                            <div class="form-group"><label for="company"
                                                               ...
                                                               placeholder="Agrega la segunda opcion"
                                                               class="form-control" required>
                                            </div>
                                            ...
                                            <div class="form-group"><label for="company"
                                                               ...
                                                               placeholder="Agrega la tercera opcion"
                                                               class="form-control" required>
                                            </div>
                                            ...
                                            <div class="form-group"><label for="company"
                                                               ...
                                                               placeholder="Agrega la cuarta opcion"
                                                               class="form-control" required>
                                            </div>

                                            <div class="form-group"><label for="company"
                                                                           class=" form-control-label">Agregar otra opcion
                                                </label><input type="text" name="answer"
                                                               placeholder="Agrega otra respuesta"
                                                               class="form-control" required>
                                            </div>

                                            <div class="form-group">

                                                <input type="submit" name="submit1" value="Agregar pregunta"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header"><strong>Añade una pregunta con imagenes</strong>
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="submit" name="submit2" value="Agregar pregunta"
                                                   class="btn btn-success">
